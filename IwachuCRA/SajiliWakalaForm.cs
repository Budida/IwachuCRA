...
namespace IwachuCRA
{
    public partial class SajiliWakalaForm : Form
    {
        ComboBox[] maeneo;
        public static DateTime referenceDate = new DateTime(1970, 1, 1);
        public SajiliWakalaForm()
        {
            InitializeComponent();
        }
        ...
        private void hifadhiWakalaBtn_Click(object sender, EventArgs e)
        {
            ...
            if (fullNameBox.Text.Equals("") || phoneBox.Text.Equals("") || emailBox.Text.Equals("") || fromDateTimePicker.Value.Equals("") || toDateTimePicker.Value.Equals("") || loginNameBox.Text.Equals("") || passwordBox.Text.Equals("") || idadiMaeneoBox.Text.Equals("") || !int.TryParse(idadiMaeneoBox.Text, out idadiMaeneo))
            {
            ...
            else
            {
                ...
                string username            = loginNameBox.Text;
              ...
              //process save these data into db
                ...
                try 
                {
                    ...
                    cmd.CommandText = "INSERT INTO wakala(fullname, simu, email, start_date, end_date, username, password, source_id, no_sources, user, council_code, region_code) VALUES ("+
                        "'"+fullname+"',"+
                        "'" + simu + "'," +
                        "'" + email + "'," +
                        "'" + start_date_seconds + "'," +
                    ...
                    cmd.Parameters.AddWithValue("@no_sources", no_sources);
                    cmd.Parameters.AddWithValue("@user", user);
                    cmd.Parameters.AddWithValue("@council_code", council_code);
